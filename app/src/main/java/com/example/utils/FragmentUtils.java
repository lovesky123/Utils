...
public final class FragmentUtils {
     ...
     */
    public static void showHide(final int showIndex,  final List<Fragment> fragments) {
     ...
     * @param hide 要隐藏的fragment
     */
    public static void showHide( final Fragment show,  final List<Fragment> hide) {
     ...
     * @param fragments 要隐藏的fragments
     */
    public static void showHide(final int showIndex,  final Fragment... fragments) {
     ...
     * @param hide 要隐藏的fragment
     */
    public static void showHide( final Fragment show,  final Fragment... hide) {
        for (Fragment fragment : hide) {
            putArgs(fragment, fragment != show);
        }
     ...
     * @param hide 要隐藏的fragment
     */
    public static void showHide( final Fragment show,
                                 final Fragment hide) {
        putArgs(show, false);
        putArgs(hide, true);
        operateNoAnim(show.getFragmentManager(), TYPE_SHOW_HIDE_FRAGMENT, show, hide);
     ...
     */
    public static void replace( final Fragment srcFragment,
     ...
     */
    public static void replace( final FragmentManager fm,
     ...
     * @param fm fragment管理器
     */
    public static void popAll( final FragmentManager fm) {
        popAll(fm, true);
    }
     ...
     * @param fm fragment管理器
     */
    public static void popAll( final FragmentManager fm, final boolean isImmediate) {
     ...
     */
    public static void removeTo( final Fragment removeTo, final boolean isInclusive) {
     ...
     * @param fm fragment管理器
     */
    public static void removeAll( final FragmentManager fm) {
        List<Fragment> fragments = getFragments(fm);
     ...
     */
    public static Fragment getTop( final FragmentManager fm) {
     ...
     * @return 最后加入的fragment
     */
    public static Fragment getTopInStack( final FragmentManager fm) {
        return getTopIsInStack(fm, true);
    }

    private static Fragment getTopIsInStack( final FragmentManager fm,
     ...
     * @return 顶层可见fragment
     */
    public static Fragment getTopShow( final FragmentManager fm) {
     ...
     */
    public static Fragment getTopShowInStack( final FragmentManager fm) {
        return getTopShowIsInStack(fm, true);
    }

    private static Fragment getTopShowIsInStack( final FragmentManager fm,
                                                final boolean isInStack) {
        List<Fragment> fragments = getFragments(fm);
        for (int i = fragments.size() - 1; i >= 0; --i) {
            Fragment fragment = fragments.get(i);
     ...
     */
    public static List<Fragment> getFragments( final FragmentManager fm) {
     ...
     */
    public static List<Fragment> getFragmentsInStack( final FragmentManager fm) {
        List<Fragment> fragments = getFragments(fm);
     ...
     * @return 所有fragment
     */
    public static List<FragmentNode> getAllFragments( final FragmentManager fm) {
        return getAllFragments(fm, new ArrayList<FragmentNode>());
    }

    private static List<FragmentNode> getAllFragments( final FragmentManager fm,
     ...
     * @return 所有fragment
     */
    public static List<FragmentNode> getAllFragmentsInStack( final FragmentManager fm) {
        return getAllFragmentsInStack(fm, new ArrayList<FragmentNode>());
    }

    private static List<FragmentNode> getAllFragmentsInStack( final FragmentManager fm,
                                                             final List<FragmentNode> result) {
        List<Fragment> fragments = getFragments(fm);
        for (int i = fragments.size() - 1; i >= 0; --i) {
            Fragment fragment = fragments.get(i);
     ...
     * @return 查找到的fragment
     */
    public static Fragment findFragment( final FragmentManager fm,
     ...
     * @return 是否消费回退事件
     */
    public static boolean dispatchBackPress( final FragmentManager fm) {
        List<Fragment> fragments = getFragments(fm);
     ...
     * @param color    背景色
     */
    public static void setBackgroundColor( final Fragment fragment, @ColorInt final int color) {
     ...
     * @param resId    资源Id
     */
    public static void setBackgroundResource( final Fragment fragment, @DrawableRes final int resId) {
        View view = fragment.getView();
        if (view != null) {
