...
public class DonutProgress extends View {
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = SizeUtil.dip2Px(18);
        min_size = (int) SizeUtil.dip2Px(100);
        default_stroke_width = SizeUtil.dip2Px(10);
        default_inner_bottom_text_size = SizeUtil.dip2Px(18);
