...
public final class BarUtils {
     ...
     * @param activity activity
     */
    public static void setStatusBarAlpha( final Activity activity) {
     ...
     * @param color         状态栏颜色值
     */
    public static void setStatusBarColor( final View fakeStatusBar, @ColorInt final int color) {
     ...
     * @param alpha         状态栏透明度，此透明度并非颜色中的透明度
     */
    public static void setStatusBarColor( final View fakeStatusBar,
                                         @ColorInt final int color,
                                         @IntRange(from = 0, to = 255) final int alpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;
     ...
     * @param fakeStatusBar 伪造状态栏
     */
    public static void setStatusBarAlpha( final View fakeStatusBar) {
     ...
     * @param isTop         drawerLayout是否在顶层
     */
    public static void setStatusBarAlpha4Drawer( final Activity activity,
                                                 final DrawerLayout drawer,
                                                 final View fakeStatusBar,
                                                final boolean isTop) {
