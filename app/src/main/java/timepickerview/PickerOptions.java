...
public class PickerOptions {
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.pickerview_options_1;
        } else {
            layoutRes = R.layout.pickerview_time_1;
        }
    }
    ...
    public float lineSpacingMultiplier = 2.0f; // 条目间距倍数 默认2.0
    public boolean isDialog;//是否是对话框模式
    public int dialogGravity = Gravity.CENTER;//对话框模式显示区域
