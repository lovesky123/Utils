...
public class NewSwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = com.example.utils.ColorUtils.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = com.example.utils.ColorUtils.generateBackColorWithTintColor(mTintColor);
