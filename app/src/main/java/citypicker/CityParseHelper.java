...
public class CityParseHelper {
    ...
    private String TAG = "CityParseHelper";
    ...
    public void initData(Context context) {
        ...
        try {
            String cityJson = getJson(context);
            mProvinceBeanArrayList = (ArrayList<ProvinceBean>) JSON.parseArray(cityJson, ProvinceBean.class);
        } catch (Exception e) {
            LogUtils.e(""+e);
        }
