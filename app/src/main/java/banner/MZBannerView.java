...
/**
* @function MZBannerView
* @author wulimin
* @time 2018/8/15 下午12:04
*/
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private int []mIndicatorRes= new int[]{R.mipmap.icon_dot,R.mipmap.icon_dot_sel};
    ...
    public MZBannerView( Context context,  AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public MZBannerView( Context context,  AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
